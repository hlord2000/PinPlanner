...
export function generateYamlCapabilities(mcu, isNonSecure) {
  ...
  return `# Copyright (c) 2025 Generated by nRF Pin Planner
# SPDX-License-Identifier: Apache-2.0
...
export function generateDefconfig(isNonSecure, mcu) {
  ...
  let config = `# Copyright (c) 2025 Generated by nRF Pin Planner
# SPDX-License-Identifier: Apache-2.0
...
# nRF Pin Planner cannot override that from generated board files,
...
export function generateFLPRXIPDts(mcu) {
  ...
  return `/*
 * Copyright (c) 2025 Generated by nRF Pin Planner
 * SPDX-License-Identifier: Apache-2.0
 */
...
export function generateKconfigBoard(mcu, supportsNS, supportsFLPR) {
  ...
  let content = `# Copyright (c) 2025 Generated by nRF Pin Planner
# SPDX-License-Identifier: Apache-2.0
