...
export function generateYamlCapabilities(mcu, isNonSecure) {
  ...
  return `# Copyright (c) 2025 Generated by Nordic Semiconductor Pin Planner
# SPDX-License-Identifier: Apache-2.0
...
export function generateDefconfig(isNonSecure, mcu) {
  ...
  let config = `# Copyright (c) 2025 Generated by Nordic Semiconductor Pin Planner
# SPDX-License-Identifier: Apache-2.0
...
# Nordic Semiconductor Pin Planner cannot override that from generated board files,
...
export function generateFLPRXIPDts(mcu) {
  ...
  return `/*
 * Copyright (c) 2025 Generated by Nordic Semiconductor Pin Planner
 * SPDX-License-Identifier: Apache-2.0
 */
...
export function generateKconfigBoard(mcu, supportsNS, supportsFLPR) {
  ...
  let content = `# Copyright (c) 2025 Generated by Nordic Semiconductor Pin Planner
# SPDX-License-Identifier: Apache-2.0
          ...
          mcu === "nrf54l10"
            ...
            : mcu === "nrf54lv10a"
              ...
              : mcu === "nrf54lm20a"
                ? "nRF54LM20A"
                : "nRF54L15"
        }, TF-M secure UART routing is chosen by nRF Connect SDK TF-M CMake. Nordic Semiconductor Pin Planner cannot override that from the generator, so TF-M UART logging stays disabled in the exported board files.`
...
- ${
    requiresDisabledVprLauncher(mcu)
      ? "For nRF54L05 and nRF54L10 FLPR builds against nRF Connect SDK main, build custom FLPR board targets with `-DSB_CONFIG_VPR_LAUNCHER=n`. NCS main does not ship a matching VPR launcher snippet for these generated custom boards, and Nordic Semiconductor Pin Planner cannot supply that sysbuild CMake wiring from board files alone."
