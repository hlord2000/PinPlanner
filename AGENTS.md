...
nRF Pin Planner is an **unofficial** web-based tool for visualizing and planning pin assignments for Nordic Semiconductor's nRF microcontrollers. It generates Zephyr RTOS board definition files based on user configurations.
