...
`;
  ...
  // Note: In the nRF Pin Planner UI, the user can choose which UART is used
  ...
  for (const p of peripherals) {
    ...
    if (
      ...
      content += `\t\t/*\n`;
      content += `\t\t * Console UART - in nRF Pin Planner you can select which\n`;
...
`;
  ...
  if (includeConsole) {
    config = `# Copyright (c) 2025 Generated by nRF Pin Planner
# SPDX-License-Identifier: Apache-2.0
