# nRF Pin Planner Testing Guide

This document provides a testing prompt for iterative testing of the nRF Pin Planner application using Playwright or manual browser testing.
...
```
Using Playwright, navigate to 0.0.0.0:8000 and perform the following tests on the nRF Pin Planner application:
